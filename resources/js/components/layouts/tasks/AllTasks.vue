    ...
    <div>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">All Tasks </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div id="example1_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                    ...
                    <div class="row justify-content-end"><div class="col-sm-12">
                        ...
                        <!--<select name="entries" @change="findTasks($event)" id=""  style="width: 20%; display: inline; float: right;">-->
                            ...
                            <!--&lt;!&ndash;<option value="not taken">Not Taken </option>&ndash;&gt;-->
                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                            ...
                            <tr role="row" class="even" v-for="product in theLaravelData.data" :key="product.id">
                                ...
                                <td>
                                    <img @click="hitImg()" class="the-img" :src="product.task_image" style="cursor: pointer; width: 40px; height: 50px;" alt="">
                                </td>
                                ...
                                <button      @click="hitEdit(product.id)"  class="btn btn-sm btn-primary" style="font-size: 65%;" >Edit</button>
    ...
    export default {
        ...
        methods: {
         ...
         hitImg() {
            ...
            hitEdit(id) {
                ...
                this.$router.push({name: 'tasks.edit', params: {id: id}});
                return;
            ...
            getResults(page = 1) {
                axios({
                    method: 'get',
                    url: APIURL+'/api/all-tasks?page='+page+"&limit="+this.limit+"&category_id="+this.finder,
                    headers: {
        ...
        mounted() {
            ...
            window.addEventListener('click', e => {
                ...
                // const els = document.getElementsByClassName('img-enlargable');
                //  const imgs = document.getElementsByClassName('the-img');
                //
                // const arImg = Array.from(imgs);
                //
                // arImg.forEach((item, ind) => {
                //
                //    item.classList.remove('img-enlargable');
                //
                // });
