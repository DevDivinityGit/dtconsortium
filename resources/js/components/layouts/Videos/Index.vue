    ...
    <div>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Video API links </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <router-link :to="{name: 'videos.create'}" class="btn btn-info" style="float: right">Add new Video link</router-link>
...
<script>
    export default {
        ...
        methods: {
            ...
            editUser(id) {
                this.$router.push({name: 'videos.edit', params: {'id': id}})
