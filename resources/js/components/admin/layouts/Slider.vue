<template>
    <div>
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <router-link :to="{name: 'root'}" class="brand-link">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <router-link :to="{name: 'root'}" class="d-block">{{$store.getters.getUser.name}}</router-link>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'create.plan'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>Create new Plan</p>
                                    </router-link>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'create.task'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>Create Task</p>
                                    </router-link>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'promotion.images.all'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>All Promotion images</p>
                                    </router-link>
                                </li>
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'promotion.images.create'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>Add Promotion images</p>
                                    </router-link>
                                </li>
                                <!--<li class="nav-item">-->
                                <!--<router-link :to="{name: 'create.plan'}" class="nav-link">-->
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'guid.index'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>Update Guide API</p>
                                    </router-link>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <!--<li class="nav-item">-->
                                    <!--<router-link :to="{name: 'download_api.index'}" class="nav-link">-->
                                        <!--<i class="fa fa-circle-o nav-icon"></i>-->
                                        <!--<p>All download API</p>-->
                                    <!--</router-link>-->
                                <!--</li>-->
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'download_api.create'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>All download API</p>
                                    </router-link>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'videos.index'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>All Video API</p>
                                    </router-link>
                                </li>
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'videos.create'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>Create Video API</p>
                                    </router-link>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'address.index'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>Update USDT Address</p>
                                    </router-link>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'whatsapp.index'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>Update whatsapp link</p>
                                    </router-link>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'transaction.index'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'transaction.withdrawal'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link :to="{name: 'countries.index'}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>All Country</p>
                                    </router-link>
                                </li>
                        ...
                        <!--<li class="nav-item has-treeview">-->
                            ...
                            <!--<ul class="nav nav-treeview">-->
                                ...
                                <!--<li class="nav-item">-->
                                    <!--<router-link :to="{name: 'trashed.products'}" class="nav-link">-->
                                        <!--<i class="fa fa-circle-o nav-icon"></i>-->
